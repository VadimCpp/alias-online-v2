...
import { resetCard } from '../firebase'

const ResetCard: React.FC = () => {
  ...
  return (
    <>
      <section className="mx-4 text-center mt-8 mb-8">
        <p className="mb-4"><b>Warning zone!</b></p>
        <p className="mb-4">You may want to change the card.</p>
        <button
          type="button"
          className="rounded-md border border-transparent bg-orange-100 px-4 mb-4 py-2 text-sm font-medium text-orange-900 hover:bg-orange-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-orange-500 focus-visible:ring-offset-2"
          onClick={() => openModal()}
        >
          Change the card
        </button>
